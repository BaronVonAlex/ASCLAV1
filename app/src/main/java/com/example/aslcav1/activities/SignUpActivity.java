...
public class SignUpActivity extends AppCompatActivity {
    ...
    private boolean isValidSignUpDetails() {
        if (encodedImage == null) {
            ...
            return false;
        } else if (binding.inputConfirmationPassword.getText().toString().trim().isEmpty()) {
            showToast("Confirm your Password");
            return false;
        } else if (!binding.inputPassword.getText().toString().equals(binding.inputConfirmationPassword.getText().toString())) {
